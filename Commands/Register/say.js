...
const taggess = message.guild.members.cache.filter(m => m.user.username.includes("ˣˣˡ")).size
const taggesss = message.guild.members.cache.filter(m => m.user.username.includes("xll")).size
